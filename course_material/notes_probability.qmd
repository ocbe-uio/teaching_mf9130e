...
This table contains the frequency of joint weather forecast and actual weather events.

|                |                |                 |                |
|----------------|----------------|-----------------|----------------|
|                | sunny forecast | cloudy forecast | fainy forecast |
...
-   We have to take into condieration if the twins are monozygotic or not. For that we use the law of total probability.
...
P(B|A) & =\frac{P(A|B)P(B)}{P(A)}\\
       ...
       & = \frac{1 \cdot 1/3}{1 \cdot 1/3 + 1/2 \cdot 2/3} = 0.5
