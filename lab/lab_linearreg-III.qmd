...
plot(bwt ~ age, data = birth[which(birth$smk == 'smoker'),], 
     main="Smokers")
abline(lm(bwt ~ age, 
          data = birth[which(birth$smk == 'smoker'),]), 
          col = 'blue')

plot(bwt ~ age, data = birth, 
     subset = birth$smk == 'nonsmoker', main="Non-smokers")
abline(lm(bwt ~ age, data = birth, 
          subset = birth$smk == 'nonsmoker'), col = 'blue')

plot(bwt ~ lwt, data = birth, 
     subset = birth$smk == 'smoker', main="Smokers")
abline(lm(bwt ~ lwt, data = birth, 
          subset = birth$smk == 'smoker'), col = 'blue')
