...
The probability density function of the normal distribution $X \sim \text{N}(\mu,\sigma)$, where $\mu$ is the mean and $\sigma$ is the standard deviation, is given by:
