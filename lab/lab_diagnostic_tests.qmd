...
if succesful continue with this one
...
Next, we call the command personograph using the two lists we generated before as inputs. In addition, we specify the number of person incons to be displayed, the x and y dimensions of the plot and a figure title.
